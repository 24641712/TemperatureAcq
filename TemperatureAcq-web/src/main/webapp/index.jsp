...
<div class="page-content d-flex align-items-stretch">
    ...
    <nav class="side-navbar">
        ...
        <ul class="list-unstyled">
            ...
            <li><a href="#apps" aria-expanded="false" data-toggle="collapse"> <i class="icon-interface-windows"></i>应用 </a>
            ...
            <li><a href="#forms" aria-expanded="false" data-toggle="collapse">
                <i class="fa fa-building-o"></i>Forms </a>
        ...
        <div class="row" id="report4">
            <div class="col-md-4" id="card-1">
                <div class="card card-inverse card-info">
                    <img class="card-img-top" src="${ctx}/static/img/card/c-1.jpg">
                    <div class="card-block">
            ...
            <div class="col-md-4 mt-0" id="card-2">
                <div class="card hovercard">
                    ...
                    <div class="avatar">
                        <img alt="" src="${ctx}/static/img/avatar-1.jpg" class="img-fluid">
                    </div>
                    <div class="info">
                        <div class="title">
